...
ActiveRecord::Schema.define(version: 2021_05_29_093549) do
  ...
  create_table "choosen_results_words", id: false, charset: "utf8", force: :cascade do |t|
    ...
    t.index ["choosen_result_id", "word_id"], name: "index_choosen_results_words_on_choosen_result_id_and_word_id"
  end

  create_table "queries_words", id: false, charset: "utf8", force: :cascade do |t|
    t.bigint "query_id", null: false
    t.bigint "word_id", null: false
    t.index ["query_id", "word_id"], name: "index_queries_words_on_query_id_and_word_id"
  end
